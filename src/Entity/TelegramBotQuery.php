...
use App\Repository\TelegramBotQueryRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: TelegramBotQueryRepository::class)]
class TelegramBotQuery
{
    ...
    public function setAskPhoto(string $ask_photo): static
    {
