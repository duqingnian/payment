...
use App\Repository\OrderPayinRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: OrderPayinRepository::class)]
class OrderPayin
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\Column(length: 255)]
    private ?string $merchant_jump_url = null;
    ...
    #[ORM\Column(length: 20, nullable: true)]
    private ?string $method_item = null;
    ...
    public function getMerchantJumpUrl(): ?string
    {
        return $this->merchant_jump_url;
    }

    public function setMerchantJumpUrl(string $merchant_jump_url): static
    {
        $this->merchant_jump_url = $merchant_jump_url;
    ...
    public function getMethodItem(): ?string
    {
        return $this->method_item;
    }

    public function setMethodItem(?string $method_item): static
    {
        $this->method_item = $method_item;
