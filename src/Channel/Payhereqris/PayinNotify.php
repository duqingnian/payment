...
class PayinNotify extends \App\Channel\BasePayinNotify
{
	public function get_message()
	{
		...
		$channel_pay_method = $this->entityManager->getRepository(\App\Entity\ChannelPayMethod::class)->findOneBy(['cid'=>$order->getCid(),'method'=>'qris']);
		...
		$channel_pay_method_setting = $this->entityManager->getRepository(\App\Entity\ChannelPaymentMethodSetting::class)->findOneBy(['mid'=>$order->getMid(),'cid'=>$order->getCid(),'method'=>'qris']);
